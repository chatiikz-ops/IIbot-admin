...
test("WhatsApp can provide the primary phone without being mapped as phone",()=>{const mapping={Наименование:"companyName","WhatsApp 1":"whatsapp"};assert.equal(canConfirmMapping(mapping),true);assert.equal(mapping["WhatsApp 1"],"whatsapp")});
